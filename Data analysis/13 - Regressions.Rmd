...
png("../Figures/DO TP black.png", width = 3, height = 3, res = 1000, units = "in")
do_tp <- with_lags%>%
...
layout <- rbind(c(1, 4),
                ...
                c(3, NA),
                c(3, NA))
jpeg("../Figures/MLR-lmer/Parameter estimate-all-custom layout-AF.jpeg", width = 7, height = 6, res = 600, units = "in")
...
layout <- rbind(c(1, 2),
                ...
                c(4, NA),
                c(4, NA))
jpeg("../Figures/MLR-lmer/Parameter estimate-all-ridge-af.jpeg", width = 6, height = 6, res = 600, units = "in")
grid.arrange(g1,g2,g3,g4,g5, layout_matrix=layout)
dev.off()
```
...
png("../Figures/Driver analysis AF.png", width = 7, height = 5, res = 1000, units = "in")
