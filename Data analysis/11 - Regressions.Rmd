...
aic_calculator_lmer(data_no_oxic,responses,potential_drivers, interaction = "+")
selected_drivers <- c("DO_demand_mgLd_HYPO","spring_temp","Temp_C_HYPO")
std_data <- standardize_data(data_no_oxic,responses,selected_drivers)
all_lakes_af <- mod_by_lake(data_no_oxic,responses,selected_drivers, interaction = "+")
