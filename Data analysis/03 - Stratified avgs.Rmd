...
This file loads temp/DO/productivity data and calculates mean concentrations of each focal variable during the summer stratified period. All code chunks must be run in order.
...
p = read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/4/0ece9d7b67cd49741ed7ee60192832e4")
...
#Load bathymetry
lake_bats.raw <- read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/4/6af06151bb8785235ec1b55ded19e42c")%>%
  filter(Area_m2>0)%>%
  group_by(LakeID)%>%
