...
p = read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/6/0ece9d7b67cd49741ed7ee60192832e4")
...
#Load bathymetry
lake_bats.raw <- read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/6/6af06151bb8785235ec1b55ded19e42c")%>%
  filter(Area_m2>0)%>%
  group_by(LakeID)%>%
