...
shape = read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/6/fadd3eaa25b5fdd1fc4efba70e660579")%>%
...
```{r}
#Temperature
climate = read.csv("../External data/historical_temp_output_era5.csv")
climate_sum = climate%>%
...
#Precipitation
precip = read.csv("../External data/historical_precip_output_era5.csv")
precip_sum = precip%>%
  mutate(Month = ifelse(Lat<0,Month+6,Month),
         Year = ifelse(Month>12,Year+1,Year),
         Month = ifelse(Month>12,Month-12,Month))%>%
