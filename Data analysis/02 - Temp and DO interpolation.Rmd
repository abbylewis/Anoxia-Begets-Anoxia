...
unclean_plot = unclean%>%
  ...
  geom_text(aes(x=3.05,y=190,label = paste0(
...
unclean_sd = unclean%>%
  ...
  geom_point(alpha = 0.3, color = "blue")+
  geom_text(aes(x=3.05,y=45,label = paste0(
...
Step 4: Interpolate DO, following Jane et al. (2021) - note that this will take several minutes to run all lakes
```{r}
