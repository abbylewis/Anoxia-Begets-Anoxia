...
Link to download ERA 5 temperature and precipitation data: https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-single-levels-monthly-means?tab=form
...
lakes <- read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/6/fadd3eaa25b5fdd1fc4efba70e660579") 
lakes_format <- lakes %>%
...
write.csv(combined_t_df,"../External data/historical_temp_output_era5.csv", row.names = F)
...
write.csv(combined_p_df,"../External data/historical_precip_output_era5.csv", row.names = F)
```
