...
This script loads climate data from the ERA5 re-analysis data product and matches climate data to LakeIDs by lat/lon
...
lakes <- read.csv("https://pasta-s.lternet.edu/package/data/eml/edi/1029/4/fadd3eaa25b5fdd1fc4efba70e660579") 
lakes_format <- lakes %>%
