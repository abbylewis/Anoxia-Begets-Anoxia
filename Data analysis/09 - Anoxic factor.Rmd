...
Step 5: Empirically calculate start and end of anoxia date if it can be determined within a certain range
...
for_new_model <- annual_data %>%
  ...
  dplyr::select(mixing_date, strat_Temp_C_HYPO, MeanDepth_m, Latitude_DD, Year, LakeID) %>%
  drop_na()
...
AF_two_layer <- read_csv("../Compiled data/AF - two layers.csv")
